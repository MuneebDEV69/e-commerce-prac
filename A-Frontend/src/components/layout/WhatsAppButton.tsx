/**
 * Fixed floating WhatsApp CTA. Clicking opens a chat with the store number and
 * pre-fills a starter message in the customer's compose box.
 *
 * NOTE: a wa.me link can only pre-fill the CUSTOMER's message — it cannot make
 * the business auto-send a welcome. To auto-reply "Welcome to Muneeb Ki Araish…"
 * the moment a customer messages, set a **Greeting Message** in the WhatsApp
 * Business app (Settings → Business tools → Greeting message).
 */
const PHONE = '923457546228'
const PREFILL = 'Hi Muneeb Ki Araish! 👋 I need some help with your products.'
const WHATSAPP_URL = `https://wa.me/${PHONE}?text=${encodeURIComponent(PREFILL)}`
